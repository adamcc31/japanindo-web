...
export default function AetherHero({
  ...
  align = 'center',
  maxWidth = 960,
  overlayGradient = 'linear-gradient(180deg, #000000e6, #00000080 50%, #000000f3 95%)',
  textColor = '#ffffff',
  ...
  return (
    <section
      className={['aurora-hero', spaceGrotesk.variable, className].join(' ')}
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          color: textColor,
          fontFamily: "var(--font-space-grotesk), ui-sans-serif, system-ui, -apple-system",
        }}
      >
        <div
          style={{
